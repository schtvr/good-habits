...
const CircularProgressBar = (props) => {
  ...
  // here's how we do this, boys
  // paste these suckers in as props and edit away
  // activeColor="darkviolet"   - active outer rim
  // passiveColor="darkgrey"    - inactive outer rim
  // baseColor="white"          - inner circle color
  // width={50}                 - width of progess ring
  // percent={35}               - value of progress
  // radius={100}               - radius of circle
  // duration={1200}            - animation duration - 1200 seems to be a good base value imo
  //
  // https://github.com/iamshadmirza/react-native-design-system/blob/master/src/CircularProgressBar/CircularProgressBar.stories.mdx
